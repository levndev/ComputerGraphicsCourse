...
{
    internal class CircleRenderer : Renderer
    {
        private int VAO;
        ...
        public CircleRenderer(float minSideLength, double radius, Vector2 position, Color4 color) : base(Window.DefaultShader)
        {
        ...
        private void GenerateData()
        {
            ...
            {
                var vertex = GetVertexCoordinates(i, sides, center, 1, 0);
